...
export interface FormProps {
  ...
  newFoodType?: boolean;
  newCombo?: boolean;
  toBeEditedFood?: FoodData;
  toBeEditedFoodType?: FoodTypeData;
}
  ...
  return (
    <div className="block max-w-sm rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
      <form>
        {newFood && (
          <>
            <TEInput type="text" label="Nombre" className="mb-6"></TEInput>
            <TEInput type="number" label="Precio" className="mb-6"></TEInput>
            {/* <!--Message textarea--> */}
        ...
        {toBeEditedFood && (
          <>
            <TEInput
              type="text"
              label="Nombre"
              defaultValue={toBeEditedFood.name}
              className="mb-6"
            ></TEInput>
            <TEInput
              type="number"
              label="Precio"
              defaultValue={toBeEditedFood.price}
              className="mb-6"
            ></TEInput>
            <div className="relative mb-6">
              <textarea
                className="peer border-2 block min-h-[auto] w-full rounded border-1 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:border-neutral-600 focus:border-primary"
                defaultValue={toBeEditedFood.description}
                id="exampleFormControlTextarea13"
                rows={3}
              ></textarea>
              <label
